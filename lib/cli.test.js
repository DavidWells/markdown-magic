...
node ./new-cli.js test/fixtures/md/**.md debug --transform test/fixtures/md/transform-**.md 1233535235 = hahah funky=hi --ignore test/fixtures/output/**.md --lol --whatever test/fixtures/md/syntax-**.md --foo=bar --fun lol.md what=no.md x 'xno.md' what
  */
  const rawArgv = [
...
test('test 2', () => {
  /* CLI command with list of files already passed in
    node ./new-cli.js --file '**.md' 'funky**.md' billy --foo 'bar*123'  
  */
...
test('Handles multiple string values and groups them', () => {
  /* CLI command with list of files already passed in
    node ./new-cli.js 'test/fixtures/md/bar.md' 'test/fixtures/output/foo.md'
  */
...
test('Handles multiple string GLOB values and groups them', () => {
  /* CLI command with list of files already passed in
    node ./new-cli.js 'test/fixtures/md/**.md' 'test/fixtures/output/**.md'
  */
...
test('Handles globKey set with multiple file/glob like values supplied afterwards', () => {
  /* CLI command with list of files already passed in
    node ./new-cli.js --file 'foobar.md' "funktown/bar.md" '**.md' 'funky**.md' billy --foo 'bar*123'
  */
  const rawArgv = [
    '--file',
    'foobar.md',
...
test('Handles mixed strings, glob strings, array strings, and regex strings', () => {
  /* CLI command with list of files already passed in
node ./new-cli.js --file 'test/fixtures/md/**.md' 'test/fixtures/output/**.md' '[foo.md, bar.whatever.md, /patter.md/]'
*/
  const rawArgv = [
    '--file',
    'funktown/bar.md',
...
test('Handles string arrays if globKeys set', () => {
  /* CLI command with list of files already passed in
  node ./new-cli.js --file '[**.md, /xyz**.md/]' 'funky**.md' billy --foo 'bar*123' --fuzz test/fixtures/output/**.md
  */
  const rawArgv = [
    '--file',
    '[**.md, /xyz**.md/]',
