 ...
 * @property {string} [frontmatter] - Frontmatter to parse for more links
 * @property {boolean} [unique=true] - ensure links unique
 */

/**
 * @typedef {object} LinksResult
 * @property {string[]} all - All links
 * @property {string[]} live - All live links
 * @property {string[]} relative - All relative links
 */

/**
* @typedef {object} ImagesResult
* @property {string[]} all - All images
* @property {string[]} live - All live image links
* @property {string[]} relative - All relative image links
*/

/**
* @typedef {object} findLinksResult
* @property {LinksResult} links - All images
* @property {ImagesResult} images - All live image links
*/
...
function findLinks(text, opts = {}) {
  ...
  if (frontmatter) {
    frontmatterLinks = findLinksInFrontMatter(frontmatter, findLinks)
  }

  const allLinks = normalLinks
    .concat(mdImgLinks)
    .concat(frontmatterLinks)
